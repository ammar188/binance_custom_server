...
import 'package:binance_custom_server/src/command_runner.dart';
...
void main() {
  group('BinanceCustomServerCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late BinanceCustomServerCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = BinanceCustomServerCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = BinanceCustomServerCommandRunner();
